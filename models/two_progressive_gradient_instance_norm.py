...
class BFE(nn.Module):
    def __init__(self, num_classes, width_ratio=0.5, height_ratio=0.5):
        ...
        self.in1 = nn.InstanceNorm2d(2048)
        ...
        self.in1.apply(weights_init_kaiming)

        # part2
        self.cutmix_batch_drop2 = CutMixBatchDrop(height_ratio, width_ratio)
        self.in2 = nn.InstanceNorm2d(2048)
        ...
        self.in2.apply(weights_init_kaiming)
    ...
    def forward(self, x, y=None):
        ...
        # part1 branch
        if self.training:
            grad = gradCAM(x, global_softmax_class, y)
            mask1 = 1-self.sigmoid(self.in1(grad))
            x_part1 = x_part1*mask1
        ...
        # part2 branch
        if self.training:
            grad = gradCAM(x_part1, cutmix1_softmax_feature, y)
            mask2 = 1 - self.sigmoid(self.in2(grad))
            x_part2 = mask2 * x_part2
    ...
    def get_optim_policy(self):
        params = [
            ...
            {'params': self.in1.parameters()},
            {'params': self.in2.parameters()},
        ]
        return params
