...
img_path = '/media/ivy/research/BDB_raw/batch-dropblock-network/experiment_res/spatial_based_baseline/block_position_spatial_logits/market/imgs/epoch20/'
...
class BFE(nn.Module):
    ...
    def forward(self, x, y=None):
        ...
        # block id
        global_triplet_feature = self.global_reduction(x)#*predicted_mask
        global_softmax_class = self.global_softmax(global_triplet_feature)#*predicted_mask
        ...
        if self.training:
            ...
            predicted_mask_ = predicted_mask.view(x.size()[0], -1)
