...
from models.bfe_triplet_KL_xent import ResNetBuilder, IDE, Resnet, BFE
...
from trainers.trainer import cls_tripletTrainer, cls_tripletTrainer_for_prior_posterior, cls_tripletTrainer_for_prior_posterior_multibranch
...
def train(**kwargs):
    ...
    def criterion_for_prior_posterior_multibranch(cls_score, posterior_mu, posterior_sigma, prior_mu, prior_sigma, labels):
        lkd_losses = []
        xent_losses = []
        triplet_losses = []
        losses = []
    ...
    if opt.block_choice == 'position':
        ...
        reid_trainer = cls_tripletTrainer_for_prior_posterior(opt, model, optimizer, criterion_for_prior_posterior, summary_writer)
    elif opt.block_choice == 'bfe_prior_posterior':
        reid_trainer = cls_tripletTrainer_for_prior_posterior_multibranch(opt, model, optimizer, criterion_for_prior_posterior_multibranch, summary_writer)
    else:
